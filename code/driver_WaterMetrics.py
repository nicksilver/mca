...
gis_path = "/home/nick/MEGA/workspace/mca/data/shapefiles/WaterSector/"
...
for i, sym in enumerate(syms):
    ...
    for f in fnames:
        ...
        shp_name = 'Missouri_Toston1'
        ens_med = np.median(mod_delta, axis=0)
        zs = ms.zstats(gis_path+shp_name, ens_med, precip=False, units='metric')
        zs_range = ms.zstats_range(mod_delta, gis_path+shp_name, zs, mod_list,
                                   precip=False, units='metric')
