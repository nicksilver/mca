...
mod_delta_pr = agstats_pr.mod_diff()

agstats_tmin = ms.AggStats(hist_tmin, fut_tmin)
mod_delta_tmin = agstats_tmin.mod_diff()

agstats_tmax = ms.AggStats(hist_tmax, fut_tmax)
mod_delta_tmax = agstats_tmax.mod_diff()

mod_delta_tavg = ms.temp_average(mod_delta_tmin, mod_delta_tmax)

# Plot differences
mplt.mod_diff_comp(mod_delta_pr, mod_delta_tavg, mod_list)
